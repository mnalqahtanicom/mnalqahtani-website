  ...
  return (
    <main className="motif grid min-h-screen place-items-center bg-navy px-6 text-center text-ivory">
      <div className="max-w-xl">
        ...
        <h1 className="text-3xl text-white sm:text-4xl">{t('title')}</h1>
        <p className="mt-5 text-lg font-light text-ivory/80">{t('line1')}</p>
        <p className="text-lg font-light text-ivory/80">{t('line2')}</p>
